...
##As mudanças realizadas foram a alteração da amostragem de holdout para 10-fold Cross Validation e 
...
from sklearn.model_selection import KFold, RandomizedSearchCV, RepeatedStratifiedKFold, train_test_split
