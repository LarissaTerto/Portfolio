...
##As mudanças realizadas foram a alteração da amostragem de holdout para Stratified 10-fold Cross Validation e 
#a inclusão do reajuste do limiar de classificação, a fim de se gerar uma segunda pontuação para cada modelo e comparar as performances 
...
from sklearn.model_selection import KFold, RandomizedSearchCV, RepeatedStratifiedKFold, StratifiedKFold, train_test_split
...
#Amostragem 10-Fold Cross Validation: Criação de partições de treino e teste
